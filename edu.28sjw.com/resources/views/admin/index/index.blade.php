...
<body>
    ...
    <aside class="Hui-aside">
        <div class="menu_dropdown bk_2">
            ...
            <dl id="menu-product">
                <dt><i class="Hui-iconfont">&#xe72d;</i> 试题试卷管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
                <dd>
                    <ul>
            ...
            <dl id="menu-comments">
                ...
                <dd>
                    <ul>
                        <li>
                            <a data-href="/admin/stream/index" data-title="直播流列表" href="javascript:;">直播流列表
                            </a>
                        </li>
                        <li>
                            <a data-href="/admin/live/index" data-title="直播课程" href="javascript:void(0)">直播课程
                            </a>
                        </li>
                    </ul>
                </dd>
