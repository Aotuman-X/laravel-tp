...
class ProfessionController extends Controller
{
    ...
    public function detail(){
    	//查询数据
    	$data = \App\Admin\Profession::find(Input::get('id'));
    	//展示视图
    ...
    public function pay(){
    	//获取商品的基本信息
    	$info = \App\Admin\Profession::find(Input::get('id'));
    	//引入需要的文件
    	require_once "./statics/wx/lib/WxPay.Api.php";
		require_once "./statics/wx/example/WxPay.NativePay.php";
		require_once './statics/wx/example/log.php';
		//交易数据的初始化
		...
		//输出二维码
		return "<img alt='模式二扫码支付' src='http://paysdk.weixin.qq.com/example/qrcode.php?data=" . urlencode($url2) . "' style='width:300px;height:300px;'/>";
    }
}
